...
assert "mixcr exportClones case15.clns --no-headers -vHit | sort | uniq | wc -l" "11"
assert "mixcr exportClones case15.filtered.clns --no-headers -vHit | sort | uniq | wc -l" "1"

assert "mixcr exportClones case15.clna --no-headers -vHit | sort | uniq | wc -l" "11"
assert "mixcr exportClones case15.filtered.clna --no-headers -vHit | sort | uniq | wc -l" "1"
