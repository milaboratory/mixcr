...
assert "cat case9.assemble.report.json | head -n 1 | jq -r .readsInClones" "199574"
...
assert "cat case9.assembleContigs.report.json | head -n 1 | jq -r .finalCloneCount" "25595"
