...
mixcr analyze --verbose 10x-sc-xcr-vdj-rapid \
  --species hs \
...
assert "mixcr exportClones --no-header base_single_cell.vdjcontigs.assembledCells.clns | grep -v '^WARNING' | wc -l" "6"
assert "mixcr exportClones --no-header --split-by-tags Cell base_single_cell.vdjcontigs.assembledCells.clns | grep -v '^WARNING' | wc -l" "6"
assert "mixcr exportClones --no-header --split-by-tags Molecule base_single_cell.vdjcontigs.assembledCells.clns | grep -v '^WARNING' | wc -l" "58"
assert "mixcr exportClones --no-header -tags Molecule base_single_cell.vdjcontigs.assembledCells.clns | grep -v '^WARNING' | wc -l" "58"
