...
assert "cat case8.assemble.report.json | head -n 1 | jq -r .clones" "25663"
assert "cat case8.assembleContigs.report.json | head -n 1 | jq -r .longestContigLength" "499"
assert "cat case8.assembleContigs.report.json | head -n 1 | jq -r .clonesWithAmbiguousLetters" "3546"
assert "cat case8.assembleContigs.report.json | head -n 1 | jq -r .assemblePrematureTerminationEvents" "4"
assert "cat case8.assembleContigs.report.json | head -n 1 | jq -r .finalCloneCount" "25663"
