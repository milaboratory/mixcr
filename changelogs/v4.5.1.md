...
- The `milab-human-rna-ig-umi-multiplex` preset has been updated: the pattern now trims fewer nucleotides, which facilitates C gene identification. The splits by V and J have been removed as they are redundant due to the full-length assembling feature.
