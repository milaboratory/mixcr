...
- kAligner2 has been modified to work with both TCR and BCR data, the presets previously devided by the type of data now merged into one. Also the division by `cdr3` and `full-length` presets has been depricated; now if applied the presets by default use the longest possible assembling feature according to the protocol :
  ...
  - `takara-human-bcr-cdr3` and `takara-human-bcr-full-length` are depricated and replaced by `takara-human-bcr-profiling` with assembling feature `{VDJRegion}`

  - `takara-human-tcr-V2-cdr3` and `takara-human-tcr-V2-full-length` are depricated and replaced by `takara-human-tcr-v2-profiling` with assembling feature `{VDJRegion}`

  - `takara-human-tcr-V1-cdr3` and `takara-human-tcr-V1-full-length` are depricated and replaced by `takara-human-tcr-profiling` with assembling feature `{VDJRegion}`

  - `takara-mouse-bcr-full-length` and `takara-mouse-tcr-cdr3` are depricated and replaced by `takara-mouse-tcr-profiling` with assembling feature `{VDJRegion}`

  - `takara-mouse-tcr-cdr3` and `takara-mouse-tcr-full-length` are depricated and replaced by `takara-mouse-tcr-profiling` with assembling feature `{VDJRegion}`

  - `biomed2-human-bcr-cdr3` and `biomed2-human-bcr-full-length` are depricated and replaced by `biomed2-human-bcr` with assembling feature `{CDR1Begin:CDR3End}`

  - `ampliseq-tcrb-sr-cdr3` has been depricated and replaced with `ampliseq-tcrb-sr`

  - `ampliseq-tcrb-plus-full-length` and `ampliseq-tcrb-plus-cdr3` are depricated and replaced by `ampliseq-tcrb-plus` with assembling feature `{CDR1Begin:FR4End}`

  - `irepertoire-human-rna-tcr-sr` and `irepertoire-human-rna-bcr-sr` are depricated and replaced by `irepertoire-repseq-human-sr`

  - `irepertoire-human-rna-tcr-lr` and `irepertoire-human-rna-bcr-lr` are depricated and replaced by `irepertoire-repseq-human-lr`

  - `irepertoire-mouse-rna-tcr-sr` and `irepertoire-mouse-rna-bcr-sr` are depricated and replaced by `irepertoire-repseq-mouse-sr`

  - `irepertoire-mouse-rna-tcr-lr` and `irepertoire-mouse-rna-bcr-lr` are depricated and replaced by `irepertoire-repseq-mouse-lr`

  - `irepertoire-human-dna-trb-sr` and `irepertoire-human-dna-igh-sr` are depricated and replaced by `irepertoire-repseq-human-dna-sr`

  - `irepertoire-human-dna-trb-lr` and `irepertoire-human-dna-igh-lr` are depricated and replaced by `irepertoire-repseq-human-dna-lr`

  - `milab-human-bcr-multiplex-cdr3` and `milab-human-bcr-multiplex-full-length` are depricated and replaced by `milab-human-ig-rna-multiplex` with assembling feature `{CDR1Begin:FR4End}`
  ...
  - `milab-human-tcr-rna-multiplex-cdr3` is depricated and replaced by `milab-human-tcr-rna-multiplex`

  - `milab-human-tcr-dna-multiplex-cdr3` is depricated and replaced by `milab-human-tcr-dna-multiplex`

  - `milab-mouse-tcr-rna-race-cdr3` and `milab-mouse-tcr-rna-race-full-length` are depricated and replaced by `milab-mouse-tcr-rna-race` with assembling feature `{VDJRegion}`

  - `nebnext-human-bcr-cdr3`, `nebnext-human-bcr-full-length`, `nebnext-human-tcr-cdr3`, `nebnext-human-tcr-full-length`, `nebnext-human-tcr-bcr-full-length` and `nebnext-human-tcr-bcr-cdr3` are all depricated and replaced by `nebnext-human-immune-sequencing` with assembling feature `{VDJRegion}`

  - `nebnext-mouse-bcr-cdr3`, `nebnext-mouse-bcr-full-length`, `nebnext-mouse-tcr-cdr3`, `nebnext-mouse-tcr-full-length`, `nebnext-mouse-tcr-bcr-full-length` and `nebnext-mouse-tcr-bcr-cdr3` are all depricated and replaced by `nebnext-mouse-immune-sequencing` with assembling feature `{VDJRegion}`

  - `qiaseq-human-tcr-cdr3` and `qiaseq-human-tcr-full-length` are depricated and replaced by `qiaseq-human-tcr-panel` with assembling feature `{CDR2Begin:FR4End}`.

- Some presets have been renamed to be more concordant with commercial kit names:
