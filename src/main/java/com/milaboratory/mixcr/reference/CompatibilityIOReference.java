...
public class CompatibilityIOReference {
    public static void registerV6Serializers(SerializersManager manager) {
        manager.registerCustomSerializer(GeneFeature.class, new GeneFeatureSerializerV06());
    }

    /**
     * V06 or below
     */
    static class GeneFeatureSerializerV06 implements Serializer<GeneFeature> {
        @Override
