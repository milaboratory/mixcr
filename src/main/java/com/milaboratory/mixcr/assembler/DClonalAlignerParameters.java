...
public final class DClonalAlignerParameters extends AbstractClonalAlignerParameters<DClonalAlignerParameters>
    ...
    public DClonalAlignerParameters setScoring(AlignmentScoring<NucleotideSequence> scoring) {
        this.scoring = scoring;
        return this;
    }
    ...
    public DClonalAlignerParameters clone() {
        return new DClonalAlignerParameters(relativeMinScore, featureToAlign, scoring);
    }
