...
interface FieldsCollection<in T : Any> {
    ...
    fun createFields(headerData: MetaForExport, args: Array<String>): List<FieldExtractor<T>>
    ...
    companion object {
        ...
        operator fun <T : Any, P1 : Any> invoke(
            ...
            validateArgs: FieldsCollection<*>.(MetaForExport, P1) -> Unit = { _, _ -> },
            deprecation: String? = null,
            extract: MetaForExport.(P1) -> List<Array<String>>
            ...
            override fun argsSupplier(headerData: MetaForExport, parameters: P1): List<Array<String>> =
        ...
        operator fun <T : Any, P1 : Any, P2 : Any> invoke(
            ...
            validateArgs: FieldsCollection<*>.(MetaForExport, P1, P2) -> Unit = { _, _, _ -> },
            deprecation: String? = null,
            extract: MetaForExport.(P1, P2) -> List<Array<String>>
            ...
            override fun argsSupplier(headerData: MetaForExport, parameters: Pair<P1, P2>): List<Array<String>> =
        ...
        operator fun <T : Any, P1 : Any, P2 : Any, P3 : Any> invoke(
            ...
            validateArgs: FieldsCollection<*>.(MetaForExport, P1, P2?, P3?) -> Unit = { _, _, _, _ -> },
            deprecation: String? = null,
            extract: MetaForExport.(P1, P2?, P3?) -> List<Array<String>>
...
private abstract class FieldsCollectionWithParameters<T : Any, P>(
    ...
    protected abstract fun argsSupplier(headerData: MetaForExport, parameters: P): List<Array<String>>
