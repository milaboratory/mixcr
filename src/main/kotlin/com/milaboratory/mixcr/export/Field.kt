...
abstract class Field<in T : Any> : FieldsCollection<T> {
    ...
    companion object {
        operator fun <T : Any> invoke(
            ...
            extract: RowMetaForExport.(T) -> String
        ...
        operator fun <T : Any, P1 : Any> invoke(
            ...
            override fun RowMetaForExport.extractValue(`object`: T, parameters: P1): String =
        ...
        operator fun <T : Any, P1 : Any, P2 : Any> invoke(
            ...
            override fun RowMetaForExport.extractValue(`object`: T, parameters: Pair<P1, P2>): String =
        ...
        operator fun <T : Any, P1 : Any, P2 : Any, P3 : Any> invoke(
            ...
            object : FieldWithParameters<T, Triple<P1, P2, P3>>(
                ...
                override fun RowMetaForExport.extractValue(`object`: T, parameters: Triple<P1, P2, P3>): String =
...
private class FieldParameterless<T : Any>(
    ...
    private val extract: RowMetaForExport.(T) -> String
) : Field<T>() {
